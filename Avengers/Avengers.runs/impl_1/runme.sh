...
HD_PWD='H:/Final/Avengers/Avengers.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log final_result.vdi -applog -m64 -messageDb vivado.pb -mode batch -source final_result.tcl -notrace
